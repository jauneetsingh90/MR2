...
def vector_search_prompt(user_query):
    return f"Search for information about Livspace services, product details, pricing, and customer support.\n\nQuery: \"{user_query}\""

def combined_search_prompt(user_query, graph_triples, vector_results, colbert_results):
    return (
        f"The user asked about HDFC Bank account opening and transferring money. Below is the retrieved information from the knowledge graph, vector search results, and Colbert search results. Use this to answer the user's question.\n\n"
...
ANSWER_PROMPT = (
    "The user asked about HDFC Bank account opening and transferring money process. Below is the retrieved information from the knowledge graph and vector search results. Use this to answer the user's question.\n\n"
...
# Streamlit app
st.title("Livspace Customer Support Bot")
